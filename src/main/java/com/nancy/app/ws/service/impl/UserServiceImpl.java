...
import com.nancy.app.ws.io.repositories.UserRepository;
...
public class UserServiceImpl implements UserService {
	...
	public UserDto createUser(UserDto userDto) {
		...
		// pour verifier si le champs existe deja dans la base et renvoyer un message
		// user friendly
		// NOTE: on peut mettre la contrainte "unique = true" dans la column concernée
		// de la classe entity
		if (userRepository.findByEmail(userDto.getEmail()) != null)
			throw new RuntimeException("Record already exists"); // TODO créer mes propres checked exceptions
		...
		// utilisation de Spring Secu pour crypter le mot de passe de l'utilisateur
		// avant de la storer
		userEntity.setEncryptedPassword(bCryptPasswordEncoder.encode(userDto.getPassword()));

		// userEntity.setUserId("testUSerId"); je génère manuellement un secure public
		// user id
	...
	// Vu que UserService étend UserDetailService de SpringSécu, cette methode est
	// rajoutée à l'implem
	...
	// Besoin d'infos sur l'tuilisateur connecté
	@Override
